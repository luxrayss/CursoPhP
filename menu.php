<nav class="modulos">
    ...
    <div class="modulo vermelho-escuro">
        ...
        <ul>            
            <li>
                <a href="exercicio.php?dir=banco&file=criar_banco">
                    Criar Banco
                </a>
            </li>
            <li>
                <a href="exercicio.php?dir=banco&file=criar_tabela">
                    Criar Tabela
                </a>
            </li>
            <li>
                <a href="exercicio.php?dir=banco&file=inserir_1">
                    Inserir Registro 01
                </a>
            </li>
            <li>
            ...
            <li>
                <a href="exercicio.php?dir=banco&file=excluir_01">
                    Excluir Registro 01
                </a>
            </li>
            <li>
                <a href="exercicio.php?dir=banco&file=desafio_consulta">
                    Desafio Consulta
                </a>
            </li>
            <li>
    ...
    <div class="modulo vermelho-escuro">
        <h3>13. API</h3>
            <ul>
                ...
                <li>
                    <a href="exercicio.php?dir=api&file=escrever-arquivo">
                        Escrever Arquivo
                    </a>
                </li>
                <li>
                    <a href="exercicio.php?dir=api&file=escrever-le_arquivo">
                        Lê Arquivo
                    </a>
                </li>
                <li>
    ...
    <div class="modulo laranja-escuro">
            ...
            <ul>
                <li>
                    <a href="exercicio.php?dir=tratamento_erro&file=tratamento_erro">
                        Tratamento de Erros
                    </a>
                </li>
                <li>
    ...
    <div class="modulo roxo-escuro">
        ...
        <ul>
            <li>
                <a href="exercicio.php?dir=exercicios-&file=ex1">
                    Exercício 1
                </a>
            </li>
        </ul>
